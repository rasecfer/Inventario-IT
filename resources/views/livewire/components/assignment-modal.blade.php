<div>
    <div wire:keep x-show="$wire.isOpen" x-transition:enter="transition ease-out duration-300"
        ...
        <div x-show="$wire.isOpen" x-transition:enter="transition ease-out duration-300"
            ...
            class="relative w-2/3 overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-gray-800">

            <!-- Header -->
            <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                    Seleccionar Asignación</h3>
            ...
            <div
                ...
                {{-- Table --}}
                <div class="mt-4 w-full overflow-x-auto rounded-lg">
                    <table class="w-full">
                        <thead
                            ...
                            @forelse($assignments as $assignment)
                                <tr class="bg-slate-200 hover:bg-slate-300 dark:bg-slate-700 hover:dark:bg-slate-600"
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-center">
                                        <button type="button" wire:click="assignmentSelected({{ $assignment }})"
