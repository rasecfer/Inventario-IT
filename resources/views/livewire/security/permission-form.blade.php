<div>
    ...
    <div
        ...
        <form wire:submit="save">
            <div class="grid w-full grid-cols-1 gap-0 md:grid-cols-2">
                <div class="w-full">
                    <label for="role_id" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        Rol <span class="text-red-500">*</span>
                    </label>
                    <select wire:model.live="roleId" id="roleId"
                        class="@error('roleId') border-red-500 @enderror w-full rounded-lg border border-gray-300 px-4 py-3 focus:border-transparent focus:ring-2 focus:ring-purple-500">
                ...
                @if ($roleId)
                    <div class="mb-2 mt-2 md:col-span-2">
                        <flux:separator text="Permisos" />
                    </div>
                    @foreach ($permissions as $permission)
                        <div class="mr-4 flex items-center justify-start">
                            <label class="relative flex cursor-pointer items-center rounded-full p-3" for="permission"
                                data-ripple-dark="true">
                                <input id="permission" type="checkbox" name="permission" wire:model="newPermissions"
