    ...
    <div class="bg-linear-to-r rounded-xl from-gray-600 to-blue-400 shadow-lg">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-white">Liberaciones</h1>
                    <p class="mt-1 text-green-100"></p>
                </div>
                <div>
                    <a href="/processes/releases/create"
        ...
        <div class="grid w-full grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" wire:model.live.debounce.300ms="search" placeholder="Buscar liberación..."
                    ...
                    @forelse($releases as $release)
                        <tr class="bg-slate-200 hover:bg-slate-300 dark:bg-slate-700 hover:dark:bg-slate-600"
                            ...
                            <td class="whitespace-nowrap px-6 py-4 text-left">
                                <div class="text-sm font-bold text-gray-600 dark:text-gray-300">
                                    {{ $release->assignment->last_name }} {{ $release->assignment->first_name }}
                                </div>
                            </td>
                            <td class="whitespace-nowrap px-6 py-4 text-left">
                                <div class="text-sm font-bold text-gray-600 dark:text-gray-300">
                                    {{ $release->assignment->department_name }}
                                </div>
                            </td>
                            <td class="whitespace-nowrap px-6 py-4 text-left">
                                <div class="text-sm font-bold text-gray-600 dark:text-gray-300">
                                    {{ $release->assignment->username }}
                                </div>
                            </td>
                            <td class="whitespace-nowrap px-6 py-4 text-left">
                                <div class="text-sm font-bold text-gray-600 dark:text-gray-300">
                            ...
                            <td class="whitespace-nowrap px-6 py-4 text-center">
                                <button type="button" wire:click="printPdf({{ $release->id }})"
