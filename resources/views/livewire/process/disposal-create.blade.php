<div>
    ...
    <div class="bg-linear-to-r rounded-xl from-gray-600 to-blue-400 shadow-lg">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-white">Nueva Baja</h1>
    ...
    <div
        ...
        <flux:callout icon="exclamation-circle" variant="warning">
            ...
            <flux:callout.text>
                Los equipos a dar de baja deben estar como "Disponibles", es decir, no estar asignados a ningún usuario.
            </flux:callout.text>
        </flux:callout>
                ...
                <div class="md:col-span-2">
                    ...
                    <select wire:model="status" id="status"
                        ...
                        @foreach (App\Enums\DeviceStatus::cases() as $status)
                            @if (in_array($status, [
                                    App\Enums\DeviceStatus::Disposed,
                                    App\Enums\DeviceStatus::Lost,
                                    App\Enums\DeviceStatus::Damaged,
                                    App\Enums\DeviceStatus::Stolen,
                                ]))
